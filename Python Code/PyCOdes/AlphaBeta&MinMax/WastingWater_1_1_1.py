    ...
    def playing(turnOrder,turn,jugs,capacity):
        ...
        while True:
            ...
            if turnOrder[turn%2] == "b":
                print("Current Jug State: \n", jugs)
                print(">> robots turn...")
                bot_move = search(jugs,capacity,searchDepth,pTarget,bTarget,lastmove,debug)
                jugs = bot_move["jugs"]
...
# TODO LIST:
# Add settings menu
# Add a rule that you can't undo you oppenents last move[might need some tweeking for the bot]
